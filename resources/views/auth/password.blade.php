...
<body class="signup-page" style="background-image : url('page.jpeg');  background-repeat: repeat; background-size: cover; -webkit-background-size: cover;
...
-o-background-size: cover;">
    ...
    <div class="signup-box" style="margin-top: 200px">
        <div class="logo">
