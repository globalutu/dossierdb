                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <button type="button" style="margin-right: 30px; float: right; padding-right: 30px; padding-left: 30px; background-color: #795548; color: white" class="btn  waves-effect" data-color="deep-orange" data-toggle="modal" onclick="getadddossier()" data-target="#add">Ajouter</button>
                                @endif
                            <br>
                            </h2>
                        </div>
                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                        <input class=" form-control" type="text" id="check" name="check" style="border:1px solid #795548;"  id="search" placeholder="... "> 
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                        <button class=" form-control" onclick="search()" value="Rechercher" style="border:1px solid #795548; color:white; background:#795548" id="sub"> <i class="material-icons">search</i> </button>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <label id="infoadd"></label>
                    <div class="row clearfix">
                        <div class="col-md-4">
                                ...
                                <div class="form-line">
                                    <select type="text" id="denom" name="denom" onchange="changetypeclient()" class="form-control" placeholder="" required>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="form-line" id="seetranche">
                                    <select type="text" id="tranche" name="tranche" class="form-control"  placeholder="">
                                </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4" id="seepourcentage">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="taux" name="taux" class="form-control"  placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4" id="seemontantassist">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="montantassist" name="montantassist" class="form-control"  placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="number" id="montant"  disabled name="montant"   class="form-control" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="number" id="montantwrite" name="montantwrite"   class="form-control" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button  onclick="setdossiers()" style="background-color: #795548; color: white" class="btn  waves-effect">AJOUTER</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm waves-effect waves-light" data-dismiss="modal">FERMER</button>
                <button  onclick="setupdatedossiers()" style="background-color: #795548; color: white" class="btn  waves-effect">MODIFIER</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
                    ...
                    if(seach == "")
                    {
                        ...
                        if(response.status == 200)
                        {
                            ...
                            tr.innerHTML = ` 
                                            ...
                                            <th data-priority="3">Date fin</th> 
            ...
            function changetypeclient() {
                ...
                let select = `<select type="text" id="tranche" onchange="changetaux()" name="tranche" class="form-control"  placeholder=""> </select>`;
            ...
            function getadddossier() {
                /** Pré remplir les types de services **/
                            ...
                            let select = '<select type="text" onchange="changecontenutranche()" id="typeservice" name="typeservice" class="form-control"  placeholder="">';
            ...
            function changecontenutranche() {
                ...
                let select = `<select type="text" id="tranche" onchange="changetaux()" name="tranche" class="form-control"  placeholder="">`;
            ...
            function changetaux() {
                ...
                listparamservices.forEach(optionText => {
                    ...
                    if(optionText.id == plage){
                        if(optionText.montantcontrat == 0 && optionText.tauxcontrat == 0 && optionText.typeclient == personne){
            ...
            async function setdossiers(){
                ...
                let data = {typeclient: typeclient, raison: raison, nom: nom, prenom: prenom, montantwrite: montantwrite, objet: objet, datedebut: datedebut, 
                    datefin: datefin, commentaire: commentaire, service: idparam};
