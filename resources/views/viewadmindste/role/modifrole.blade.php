...
<div class="container-fluid">
	<div class="block-header">
		...
		<h2>
			<a style="color:#795548" href="{{ route('dashboard') }}"> Tableau de bord </a> / <a style="color:#795548" href="{{ route('GR')}}"> Roles </a>/ Modification
			<small></small>
		</h2>
	</div>
					...
					<div class="row">
						...
						<form style="padding : 20px" method="post" action="{{ route('SRL') }}" >
							...
							<div class="form-group" style="display: block;" >
								<div class="col-sm-12">
									<button type="submit" class="btn waves-effect" style="float:right; margin-top: 20px; margin-left: 15px; background-color: #795548; color:white; width: 25%;">Mettre Ã  jour
									</button>
								</div>
							</div>
						</form>	
