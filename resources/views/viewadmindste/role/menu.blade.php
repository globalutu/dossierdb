...
<div class="container-fluid">
	<div class="block-header">
		<h2>
			<a style="color:#795548" href="{{ route('dashboard') }}"> Tableau de bord </a> / <a style="color:#795548" href="{{ route('GR')}}"> Roles </a>/ Attribution Menu
			<small></small>
		</h2>
	</div>
				...
				<div class="body">
					...
					<form class="form-horizontal" method="post" action="{{ route('MenuAttr') }}" >
						...
						<div class="form-group " style="display: block;" >
							<div class="col-sm-12">
								<button type="submit"  class=" btn-sm waves-effect waves-light" style="float:right; background-color: #795548; color:white; margin-top: -60px; margin-left: 15px; width: 25%;">Attribuer
								</button>
							</div>
						</div>
					</form>	
