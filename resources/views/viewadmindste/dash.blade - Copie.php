                        ...
                        <div class="body">
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    <thead>
                                        <form class="form-horizontal" action="{{ route('dashboard') }}" method="GET" id="recherche">
                                        <tr>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <input class=" form-control" type="hidden" name="rec" value="1">
                                            <th colspan="2"> 
                                            <input class=" form-control" type="text" name="check" style="border:1px solid #795548;"  id="search" placeholder="... "> 
                                            </th>
                                            
                                            <th data-priority="1">
                                                <input class=" form-control" type="submit" value="Rechercher" style="border:1px solid #795548; color:white; background:#795548" id="sub"></th>
                                           <th colspan="6"> </th>
                                            <th> 
                                            <a href="{{ route('dashboard') }}">
                                            <button type="button" style="margin-right: 30px; float: right; padding-right: 30px; 
                                            padding-left: 30px; background-color: #795548; color: white" class="btn  waves-effect"> Actualiser </button> </a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr> 
                                            ...
                                            <button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                <a href="{{ route('UDOS', $vcs->id)}}" style="color:white;"> <i class="material-icons">system_update_alt</i></a> 
                                            ...
                                            <button type="button" title="Rencontre"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                <a href="{{ route('RDOS', $vcs->id)}}" style="color:white;"> <i class="material-icons">group</i></a> 
                                            ...
                                            <button type="button" title="Trésorerie"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
                                                <a href="{{ route('TDOS', $vcs->id)}}" style="color:white;"> <i class="material-icons">poll</i></a> 
                                                
                                            </button>
                                            @endif

                                            @if(in_array("delete_vc", session("auto_action")))
                                            <button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="{{ route('DDOS', $vcs->id)}}" style="color:white;"><i class="material-icons">delete_sweep</i></a> </button>
                                            @endif
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="10"><center>Pas de dossier enregistrer!!!</center> </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="prenom" name="prenom" class="form-control" required placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <textarea type="text" id="objet" name="objet" class="form-control" required placeholder=""></textarea>
                            </div>
                           </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <div class="form-line">
                                    <input type="date" id="datedebut" name="datedebut" class="form-control" required placeholder="">
                                </div>
                            </div>
                        </div>
