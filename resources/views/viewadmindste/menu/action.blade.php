...
<div class="container-fluid">
	<div class="block-header">
		...
		<h2>
			<a style="color:#795548" href="{{ route('dashboard') }}"> Tableau de bord </a> / <a style="color:#795548" href="{{ route('GM')}}"> Menu </a>/ Actions
			<small></small>
		</h2>
	</div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
							...
							<div class="form-group" style="display: block;" >
								<div class="col-sm-12">
									<button type="submit" class="btn waves-effect" style="float:right; margin-top: 20px; margin-left: 15px; background-color: #795548; color:white; width: 25%;">Ajouter
									</button>
								</div>
							</div>
						</form>	
