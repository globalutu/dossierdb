					...
					<div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th data-priority="1">Encaissement</th>
                                        <th data-priority="1">Décaissement</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th><span class="co-name">18-08-2024</span></th>
                                            <td>Encaissement reçue</td>
                                            <td style="text-align: right;">100 000</td>
                                            <td style="text-align: right;">0</td>
                                            <td style="text-align: right;">100 000</td>
                                            <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                                <label for="nom">Nom, prénom et titre client </label>
                                <div class="form-group">
                                <div class="form-line">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label id="infoupdate"></label>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                                <label for="nom_u">Nom, prénom et titre client </label>
                                <div class="form-group">
                                <div class="form-line">
